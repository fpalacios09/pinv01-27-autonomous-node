...
const byte RXD2 = D11; // RX desde la Jetson / adaptador externo
const byte TXD2 = D12; // TX hacia la Jetson / adaptador externo

// Nano 33 BLE (nRF52840 / Arduino Mbed):
// la UART se crea indicando TX y RX en el constructor.
arduino::UART usbSerial(TXD2, RXD2);
...
void setup() {
  ...
  usbSerial.begin(115200, SERIAL_8N1);
  Serial.begin(115200);

  // Mantener la misma escala ADC usada por el firmware original:
  // 0...4095 corresponde a 12 bits.
